...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Karolina Queiroz";
    private static final String CONTACT_GITHUB = "https://github.com/karolinaq20";
    private static final String CONTACT_EMAIL = "karolinaq20@hotmail.com";
